...
from utils import SimpleLLM, prefix_with, ChatCompletionSettings, SimpleRAG
...
class RepoRAGMetric(Metric):
    def eva(self, ctx):
        ...
        # 回答每个问题
        rag = SimpleRAG(model='Amu/tao-8k', tokenizer='Amu/tao-8k', dim=1024)
